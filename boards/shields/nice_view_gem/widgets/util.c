...
void canvas_draw_label(lv_obj_t *canvas, lv_coord_t x, lv_coord_t y, lv_coord_t max_w,
                       lv_draw_label_dsc_t *draw_dsc, const char *text) {
    lv_layer_t layer;
    lv_canvas_init_layer(canvas, &layer);
    lv_coord_t h = draw_dsc->font ? draw_dsc->font->line_height : 16;
